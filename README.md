  ...
  * [Labs](#labs)
    + [Incomplete if](#incomplete-if)
      ...
      - [Example 2](#example-2-3)
        * [Verilog code for RTL Design](#verilog-code-for-rtl-design)
        * [RTL Simulation](#rtl-simulation)
        * [Synthesis report](#synthesis-report)
        * [Synthesized netlist](#synthesized-netlist)
        * [RTL Code for synthesized netlist](#rtl-code-for-synthesized-netlist)
        * [Gate Level Simulation](#gate-level-simulation)
    + [Incomplete Case statement lab](#incomplete-case-statement-lab)
      - [Verilog code for the RTL Design](#verilog-code-for-the-rtl-design)
      - [Expected circuit](#expected-circuit)
      - [RTL Simulation](#rtl-simulation-1)
      - [Synthesis Report](#synthesis-report)
      - [Synthesized netlist](#synthesized-netlist-1)
      - [Verilog code for the synthesized netlist](#verilog-code-for-the-synthesized-netlist)
      - [Gate Level Simulation](#gate-level-simulation-1)
    + [Case statement with default case](#case-statement-with-default-case)
      - [Verilog code for the RTL Design](#verilog-code-for-the-rtl-design-1)
      - [Expected circuit](#expected-circuit-1)
      - [RTL Simulation](#rtl-simulation-2)
      - [Synthesis Report](#synthesis-report-1)
      - [Synthesized netlist](#synthesized-netlist-2)
      - [Verilog code for the synthesized netlist](#verilog-code-for-the-synthesized-netlist-1)
    + [Case statement with partial output assignments](#case-statement-with-partial-output-assignments)
      - [Verilog code for the RTL Design](#verilog-code-for-the-rtl-design-2)
      - [Expected circuit](#expected-circuit-2)
      - [RTL Simulation](#rtl-simulation-3)
      - [Synthesis Report](#synthesis-report-2)
      - [Synthesized netlist](#synthesized-netlist-3)
      - [Verilog code for the synthesized netlist](#verilog-code-for-the-synthesized-netlist-2)
      - [Gate Level Simulation](#gate-level-simulation-2)
      - [Gate Level Simulation](#gate-level-simulation-3)
- [Author](#author)
